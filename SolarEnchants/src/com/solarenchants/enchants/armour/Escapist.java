...
public class Escapist extends SolarEnchantment{

	public Escapist(String enchant, RARITY rarity, String target) {
	...
	public void onPlayerMove(PlayerMoveEvent e) {
		...
		e.getPlayer().addPotionEffect(new PotionEffect(PotionEffectType.SPEED, 45, level));
	...
	public String description() {
		...
		return "Gives the user a swiftness effect.";
	}
